...
import DragonMod.cards.cardvars.SecondDamage;
import DragonMod.cards.cardvars.SecondMagicNumber;
import DragonMod.relics.AbstractEasyRelic;
...
public class DragonMod implements
    ...
    public static boolean wasDamagedThisTurn = false;
    ...
    public static void initialize() {
        DragonMod thismod = new DragonMod();
    }
