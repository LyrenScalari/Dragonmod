...
import dragonmod.cards.Justicar.starter.Cauterize;
import dragonmod.cards.Justicar.starter.JusticarDefend;
import dragonmod.cards.Justicar.starter.JusticarStrike;
import dragonmod.cards.Justicar.starter.Sunbeam;
...
public class TheJusticar extends CustomPlayer {
    ...
    public static class Enums {
        @SpireEnum
        public static PlayerClass THE_JUSTICAR;
    ...
    private static final String ID = makeID("TheJusticar");
    ...
    public TheJusticar(String name, PlayerClass setClass) {
        super(name, setClass, new EnergyOrbJusticar(),
    ...
    public AbstractPlayer newInstance() {
        return new TheJusticar(name, chosenClass);
    }
