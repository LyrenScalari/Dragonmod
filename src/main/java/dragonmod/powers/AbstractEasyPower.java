...
public class AbstractEasyPower extends TwoAmountPower {
    public AbstractEasyPower(String NAME, PowerType powerType, boolean isTurnBased, AbstractCreature owner, int amount) {
        ...
        Texture normalTexture = TextureLoader.getTexture(DragonMod.modID + "/powers/" + NAME.replaceAll("([ ])", "") + "32.png");
        Texture hiDefImage = TextureLoader.getTexture(DragonMod.modID + "/powers/" + NAME.replaceAll("([ ])", "") + "84.png");
        if (hiDefImage != null) {
