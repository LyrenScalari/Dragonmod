...
public class CommonPower extends AbstractPower implements CloneablePowerInterface {
    ...
    public static final String POWER_ID = DragonMod.makeID("CommonPower");
    ...
    private static final Texture tex84 = TextureLoader.getTexture(powerPath("placeholder_power84.png"));
    private static final Texture tex32 = TextureLoader.getTexture(powerPath("placeholder_power.png"));
