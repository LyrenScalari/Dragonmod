...
public class PrimalStrike extends AbstractPrimalCard {


    // TEXT DECLARATION

    public static final String ID = DragonMod.makeID(PrimalStrike.class.getSimpleName()); // USE THIS ONE FOR THE TEMPLATE;
